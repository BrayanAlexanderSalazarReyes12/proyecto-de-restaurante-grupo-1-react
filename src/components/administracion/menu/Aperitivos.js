...
export default class Aperitivos extends Component{
    constructor(props) {
        super(props);
        this.state = { 
            datos: [],
    ...
    render(){
        ...
        return this.state.datos.map((data) => {
            const hanldeFileChange = (e) => {
                ...
                const newUrlImage = updateImage(data.img, file,'aperitivos')
            ...
            const Actualizaraperitivos=async(id,nombre,img,tokenimg,descrip,precio)=>{
            ...
            const Eliminaraperitivos=async(id,img)=>{
                deleteImage(img,'aperitivos')
                        ...
                        <div class='card h-100 card-radius'>
                            ...
                            <div class='card-body'>
                                ...
                                <div class="card-body">
                                    ...
                                    <button onClick={()=>Eliminaraperitivos(data.id,data.img)} class='card-titulo btn-general' data-bs-toggle='modal' data-bs-target='#exampleModalProducto'>Eliminar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='modal-dialog'>
                            <div className='modal-content'>
                                ...
                                <h1>Precio<input onChange={(ev)=>{this.syncPrecio(ev.target.value,'precio')}} placeholder={data.precio} value={this.state.precio} className="form-control mb-2" type="text" name='precio' /></h1>
                                    ...
                                    <button id="add_cart" type='file' className='btn-general' onClick={()=>Actualizaraperitivos(data.id,data.nombre,data.img,data.tokenimg,data.descrip,data.precio)}>Actualizar</button>
